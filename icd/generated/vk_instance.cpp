...
void Instance::DestroyInstance(const VkAllocationCallbacks* pAllocator) {
    return dispatch_table_.DestroyInstance(handle_, pAllocator);
}
...
VkResult Instance::EnumeratePhysicalDeviceGroups(uint32_t* pPhysicalDeviceGroupCount,
    ...
    return dispatch_table_.EnumeratePhysicalDeviceGroups(handle_, pPhysicalDeviceGroupCount, pPhysicalDeviceGroupProperties);
}

void Instance::DestroySurfaceKHR(VkSurfaceKHR surface, const VkAllocationCallbacks* pAllocator) {
    return dispatch_table_.DestroySurfaceKHR(handle_, surface, pAllocator);
}
...
void Instance::DestroyDebugReportCallbackEXT(VkDebugReportCallbackEXT callback, const VkAllocationCallbacks* pAllocator) {
    return dispatch_table_.DestroyDebugReportCallbackEXT(handle_, callback, pAllocator);
}
...
void Instance::DebugReportMessageEXT(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objectType, uint64_t object,
    ...
    return dispatch_table_.DebugReportMessageEXT(handle_, flags, objectType, object, location, messageCode, pLayerPrefix, pMessage);
}
...
void Instance::DestroyDebugUtilsMessengerEXT(VkDebugUtilsMessengerEXT messenger, const VkAllocationCallbacks* pAllocator) {
    return dispatch_table_.DestroyDebugUtilsMessengerEXT(handle_, messenger, pAllocator);
}

void Instance::SubmitDebugUtilsMessageEXT(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
                                          VkDebugUtilsMessageTypeFlagsEXT messageTypes,
                                          const VkDebugUtilsMessengerCallbackDataEXT* pCallbackData) {
    return dispatch_table_.SubmitDebugUtilsMessageEXT(handle_, messageSeverity, messageTypes, pCallbackData);
}
