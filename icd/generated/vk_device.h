...
class Device {
  public:
    Device(VkDevice handle, const DispatchTable& dispatch_table, icd::FaultHandler& fault_handler)
    ...
    VkResult ReleaseSwapchainImagesEXT(const VkReleaseSwapchainImagesInfoKHR* pReleaseInfo);
