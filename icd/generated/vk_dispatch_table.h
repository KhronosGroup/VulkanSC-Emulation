...
class DispatchTable {
  public:
    ...
    const PFN_vkReleaseSwapchainImagesKHR ReleaseSwapchainImagesKHR;
    ...
    const PFN_vkCmdDecompressMemoryEXT CmdDecompressMemoryEXT;
    const PFN_vkCmdDecompressMemoryIndirectCountEXT CmdDecompressMemoryIndirectCountEXT;
