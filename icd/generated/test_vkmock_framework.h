...
class vkmock {
  ...
  public:
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkRenderingAttachmentLocationInfo* pLocationInfo)>
    ...
    inline static std::function<VkResult(VkDevice device, const VkMemoryMapInfo* pMemoryMapInfo, void** ppData)> MapMemory2KHR{};
    inline static std::function<VkResult(VkDevice device, const VkMemoryUnmapInfo* pMemoryUnmapInfo)> UnmapMemory2KHR{};
    inline static std::function<VkResult(VkPhysicalDevice physicalDevice,
    ...
    inline static std::function<VkResult(VkQueue queue, uint32_t submitCount, const VkSubmitInfo2* pSubmits, VkFence fence)>
        QueueSubmit2KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkBindIndexBuffer3InfoKHR* pInfo)>
        CmdBindIndexBuffer3KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount,
                                     const VkBindVertexBuffer3InfoKHR* pBindingInfos)>
        CmdBindVertexBuffers3KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo)> CmdDrawIndirect2KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo)>
        CmdDrawIndexedIndirect2KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkDispatchIndirect2InfoKHR* pInfo)>
        CmdDispatchIndirect2KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryInfoKHR* pCopyMemoryInfo)>
        CmdCopyMemoryKHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo)>
        CmdCopyMemoryToImageKHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo)>
        CmdCopyImageToMemoryKHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkDeviceAddressRangeKHR* pDstRange,
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo)>
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount,
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkMemoryMarkerInfoAMD* pInfo)>
        CmdWriteMarkerToMemoryAMD{};
    inline static std::function<VkResult(VkDevice device, const VkAccelerationStructureCreateInfo2KHR* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator,
    ...
    inline static std::function<void(VkDevice device, const VkRenderingAreaInfo* pRenderingAreaInfo, VkExtent2D* pGranularity)>
        GetRenderingAreaGranularityKHR{};
    inline static std::function<void(VkDevice device, const VkDeviceImageSubresourceInfo* pInfo, VkSubresourceLayout2* pLayout)>
    ...
    inline static std::function<VkResult(VkDevice device, VkSwapchainKHR swapchain, const VkPresentWait2InfoKHR* pPresentWait2Info)>
        WaitForPresent2KHR{};
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkBindDescriptorSetsInfo* pBindDescriptorSetsInfo)>
        CmdBindDescriptorSets2KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkPushConstantsInfo* pPushConstantsInfo)>
        CmdPushConstants2KHR{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkPushDescriptorSetInfo* pPushDescriptorSetInfo)>
    ...
    inline static std::function<VkResult(VkDevice device, uint64_t timeout, uint32_t* pFaultCounts,
                                         VkDeviceFaultInfoKHR* pFaultInfo)>
        GetDeviceFaultReportsKHR{};
    inline static std::function<VkResult(VkDevice device, VkDeviceFaultDebugInfoKHR* pDebugInfo)> GetDeviceFaultDebugInfoKHR{};
...
#endif  // VK_USE_PLATFORM_ANDROID_KHR
    inline static std::function<VkResult(VkDevice device, const VkGpaSessionCreateInfoAMD* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator, VkGpaSessionAMD* pGpaSession)>
        CreateGpaSessionAMD{};
    inline static std::function<void(VkDevice device, VkGpaSessionAMD gpaSession, const VkAllocationCallbacks* pAllocator)>
        DestroyGpaSessionAMD{};
    inline static std::function<VkResult(VkDevice device, VkGpaDeviceClockModeInfoAMD* pInfo)> SetGpaDeviceClockModeAMD{};
    inline static std::function<VkResult(VkDevice device, VkGpaDeviceGetClockInfoAMD* pInfo)> GetGpaDeviceClockInfoAMD{};
    inline static std::function<VkResult(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession)> CmdBeginGpaSessionAMD{};
    inline static std::function<VkResult(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession)> CmdEndGpaSessionAMD{};
    inline static std::function<VkResult(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession,
                                         const VkGpaSampleBeginInfoAMD* pGpaSampleBeginInfo, uint32_t* pSampleID)>
        CmdBeginGpaSampleAMD{};
    inline static std::function<void(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession, uint32_t sampleID)>
        CmdEndGpaSampleAMD{};
    inline static std::function<VkResult(VkDevice device, VkGpaSessionAMD gpaSession)> GetGpaSessionStatusAMD{};
    inline static std::function<VkResult(VkDevice device, VkGpaSessionAMD gpaSession, uint32_t sampleID, size_t* pSizeInBytes,
                                         void* pData)>
        GetGpaSessionResultsAMD{};
    inline static std::function<VkResult(VkDevice device, VkGpaSessionAMD gpaSession)> ResetGpaSessionAMD{};
    inline static std::function<void(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession)> CmdCopyGpaSessionResultsAMD{};
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, VkPipeline executionGraph, VkDeviceAddress scratch,
                                     VkDeviceSize scratchSize)>
        CmdInitializeGraphScratchMemoryAMDX{};
    inline static std::function<void(VkCommandBuffer commandBuffer, VkDeviceAddress scratch, VkDeviceSize scratchSize,
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, VkStencilFaceFlags faceMask, VkStencilOp failOp,
        ...
        CmdSetStencilOpEXT{};
    inline static std::function<VkResult(VkDevice device, const VkCopyMemoryToImageInfo* pCopyMemoryToImageInfo)>
        CopyMemoryToImageEXT{};
    inline static std::function<VkResult(VkDevice device, const VkCopyImageToMemoryInfo* pCopyImageToMemoryInfo)>
        CopyImageToMemoryEXT{};
    inline static std::function<VkResult(VkDevice device, const VkCopyImageToImageInfo* pCopyImageToImageInfo)>
        CopyImageToImageEXT{};
    ...
    inline static std::function<void(VkDevice device, VkObjectType objectType, uint64_t objectHandle,
        ...
        GetPrivateDataEXT{};
    inline static std::function<VkResult(VkQueue queue, const VkPerfHintInfoQCOM* pPerfHintInfo)> QueueSetPerfHintQCOM{};
#ifdef VK_ENABLE_BETA_EXTENSIONS
...
#endif  // VK_ENABLE_BETA_EXTENSIONS
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkDispatchTileInfoQCOM* pDispatchTileInfo)>
        CmdDispatchTileQCOM{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkPerTileBeginInfoQCOM* pPerTileBeginInfo)>
        CmdBeginPerTileExecutionQCOM{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkPerTileEndInfoQCOM* pPerTileEndInfo)>
    ...
    inline static std::function<VkResult(VkDevice device, const VkPipelineInfoKHR* pPipelineInfo,
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkDispatchParametersARM* pDispatchParameters)>
    ...
    inline static std::function<VkResult(VkDevice device, const VkTensorCreateInfoARM* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator, VkTensorARM* pTensor)>
        CreateTensorARM{};
    inline static std::function<void(VkDevice device, VkTensorARM tensor, const VkAllocationCallbacks* pAllocator)>
        DestroyTensorARM{};
    inline static std::function<VkResult(VkDevice device, const VkTensorViewCreateInfoARM* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator, VkTensorViewARM* pView)>
        CreateTensorViewARM{};
    inline static std::function<void(VkDevice device, VkTensorViewARM tensorView, const VkAllocationCallbacks* pAllocator)>
        DestroyTensorViewARM{};
    inline static std::function<void(VkDevice device, const VkTensorMemoryRequirementsInfoARM* pInfo,
                                     VkMemoryRequirements2* pMemoryRequirements)>
        GetTensorMemoryRequirementsARM{};
    inline static std::function<VkResult(VkDevice device, uint32_t bindInfoCount, const VkBindTensorMemoryInfoARM* pBindInfos)>
        BindTensorMemoryARM{};
    inline static std::function<void(VkDevice device, const VkDeviceTensorMemoryRequirementsARM* pInfo,
                                     VkMemoryRequirements2* pMemoryRequirements)>
        GetDeviceTensorMemoryRequirementsARM{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkCopyTensorInfoARM* pCopyTensorInfo)> CmdCopyTensorARM{};
    inline static std::function<void(VkPhysicalDevice physicalDevice,
                                     const VkPhysicalDeviceExternalTensorInfoARM* pExternalTensorInfo,
                                     VkExternalTensorPropertiesARM* pExternalTensorProperties)>
        GetPhysicalDeviceExternalTensorPropertiesARM{};
    inline static std::function<VkResult(VkDevice device, const VkTensorCaptureDescriptorDataInfoARM* pInfo, void* pData)>
        GetTensorOpaqueCaptureDescriptorDataARM{};
    inline static std::function<VkResult(VkDevice device, const VkTensorViewCaptureDescriptorDataInfoARM* pInfo, void* pData)>
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, uint32_t stageCount, const VkShaderStageFlagBits* pStages,
        ...
        CmdBindShadersEXT{};
    inline static std::function<void(VkCommandBuffer commandBuffer, VkDepthClampModeEXT depthClampMode,
    ...
    inline static std::function<VkResult(VkDevice device, const VkConvertCooperativeVectorMatrixInfoNV* pInfo)>
    ...
    inline static std::function<VkResult(VkDevice device, const VkDataGraphPipelineSessionCreateInfoARM* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator, VkDataGraphPipelineSessionARM* pSession)>
        CreateDataGraphPipelineSessionARM{};
    inline static std::function<VkResult(VkDevice device, const VkDataGraphPipelineSessionBindPointRequirementsInfoARM* pInfo,
    ...
    inline static std::function<void(VkDevice device, const VkDataGraphPipelineSessionMemoryRequirementsInfoARM* pInfo,
                                     VkMemoryRequirements2* pMemoryRequirements)>
        GetDataGraphPipelineSessionMemoryRequirementsARM{};
    inline static std::function<VkResult(VkDevice device, uint32_t bindInfoCount,
                                         const VkBindDataGraphPipelineSessionMemoryInfoARM* pBindInfos)>
        BindDataGraphPipelineSessionMemoryARM{};
    inline static std::function<void(VkDevice device, VkDataGraphPipelineSessionARM session,
                                     const VkAllocationCallbacks* pAllocator)>
        DestroyDataGraphPipelineSessionARM{};
    inline static std::function<void(VkCommandBuffer commandBuffer, VkDataGraphPipelineSessionARM session,
                                     const VkDataGraphPipelineDispatchInfoARM* pInfo)>
        CmdDispatchDataGraphARM{};
    inline static std::function<VkResult(VkDevice device, const VkDataGraphPipelineInfoARM* pPipelineInfo,
                                         uint32_t* pPropertiesCount, VkDataGraphPipelinePropertyARM* pProperties)>
        GetDataGraphPipelineAvailablePropertiesARM{};
    inline static std::function<VkResult(VkDevice device, const VkDataGraphPipelineInfoARM* pPipelineInfo, uint32_t propertiesCount,
                                         VkDataGraphPipelinePropertyQueryResultARM* pProperties)>
        GetDataGraphPipelinePropertiesARM{};
    inline static std::function<VkResult(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex,
    ...
    inline static std::function<void(VkDevice device, VkExternalComputeQueueNV externalQueue,
                                     const VkAllocationCallbacks* pAllocator)>
        DestroyExternalComputeQueueNV{};
    inline static std::function<void(VkExternalComputeQueueNV externalQueue, VkExternalComputeQueueDataParamsNV* params,
                                     void* pData)>
        GetExternalComputeQueueDataNV{};
    inline static std::function<void(VkDevice device, const VkClusterAccelerationStructureInputInfoNV* pInfo,
    ...
    inline static std::function<void(VkDevice device, const VkPartitionedAccelerationStructureInstancesInputNV* pInfo,
                                     VkAccelerationStructureBuildSizesInfoKHR* pSizeInfo)>
        GetPartitionedAccelerationStructuresBuildSizesNV{};
    inline static std::function<void(VkCommandBuffer commandBuffer,
                                     const VkBuildPartitionedAccelerationStructureInfoNV* pBuildInfo)>
        CmdBuildPartitionedAccelerationStructuresNV{};
    inline static std::function<void(VkDevice device, const VkGeneratedCommandsMemoryRequirementsInfoEXT* pInfo,
                                     VkMemoryRequirements2* pMemoryRequirements)>
        GetGeneratedCommandsMemoryRequirementsEXT{};
    inline static std::function<void(VkCommandBuffer commandBuffer, const VkGeneratedCommandsInfoEXT* pGeneratedCommandsInfo,
                                     VkCommandBuffer stateCommandBuffer)>
        CmdPreprocessGeneratedCommandsEXT{};
    inline static std::function<void(VkCommandBuffer commandBuffer, VkBool32 isPreprocessed,
                                     const VkGeneratedCommandsInfoEXT* pGeneratedCommandsInfo)>
        CmdExecuteGeneratedCommandsEXT{};
    inline static std::function<VkResult(VkDevice device, const VkIndirectCommandsLayoutCreateInfoEXT* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator,
                                         VkIndirectCommandsLayoutEXT* pIndirectCommandsLayout)>
        CreateIndirectCommandsLayoutEXT{};
    inline static std::function<void(VkDevice device, VkIndirectCommandsLayoutEXT indirectCommandsLayout,
                                     const VkAllocationCallbacks* pAllocator)>
        DestroyIndirectCommandsLayoutEXT{};
    inline static std::function<VkResult(VkDevice device, const VkIndirectExecutionSetCreateInfoEXT* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator, VkIndirectExecutionSetEXT* pIndirectExecutionSet)>
        CreateIndirectExecutionSetEXT{};
    inline static std::function<void(VkDevice device, VkIndirectExecutionSetEXT indirectExecutionSet,
                                     const VkAllocationCallbacks* pAllocator)>
...
#ifdef VK_USE_PLATFORM_METAL_EXT
    inline static std::function<VkResult(VkDevice device, const VkMemoryGetMetalHandleInfoEXT* pGetMetalHandleInfo, void** pHandle)>
        GetMemoryMetalHandleEXT{};
    inline static std::function<VkResult(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, const void* pHandle,
    ...
    inline static std::function<VkResult(VkPhysicalDevice physicalDevice, uint32_t* pDescriptionCount,
                                         VkShaderInstrumentationMetricDescriptionARM* pDescriptions)>
        EnumeratePhysicalDeviceShaderInstrumentationMetricsARM{};
    inline static std::function<VkResult(VkDevice device, const VkShaderInstrumentationCreateInfoARM* pCreateInfo,
                                         const VkAllocationCallbacks* pAllocator, VkShaderInstrumentationARM* pInstrumentation)>
        CreateShaderInstrumentationARM{};
    inline static std::function<void(VkDevice device, VkShaderInstrumentationARM instrumentation,
                                     const VkAllocationCallbacks* pAllocator)>
        DestroyShaderInstrumentationARM{};
    inline static std::function<void(VkCommandBuffer commandBuffer, VkShaderInstrumentationARM instrumentation)>
        CmdBeginShaderInstrumentationARM{};
    inline static std::function<void(VkCommandBuffer commandBuffer)> CmdEndShaderInstrumentationARM{};
    inline static std::function<VkResult(VkDevice device, VkShaderInstrumentationARM instrumentation, uint32_t* pMetricBlockCount,
    ...
    inline static std::function<void(VkCommandBuffer commandBuffer, uint32_t primitiveRestartIndex)>
